...
function Questions (props) {
    ...
    const questionList = [
        ...
        {id: 7, title: 'Berkeley, Bay Area & Silicon Valley', source: 'https://www.youtube.com/embed/bbFoiq4bovA', icon: 'https://image.flaticon.com/icons/png/512/82/82619.png'},
        ...
        {id: 17, title: 'Business Careers', icon: 'https://i.imgur.com/SeopN4P.png'},
